...
import RecoveryCodeIcon from '../assets/recoveryCodeBack.svg';

const RecoveryCode: React.FC = () => {
  const [code, setCode] = useState('example@gmail.com');
  ...
  const handleSubmit = (e: React.FormEvent) => {
    e.preventDefault();
    console.log('Recovery code submitted:', code);
    // Handle recovery code verification here
  };
  ...
  return (
    <AuthLayout 
      ...
      backgroundImage={RecoveryCodeIcon}
    >
      <div className="mb-6">
        <p className="text-gray-300 text-sm text-center">
          Для восстановления Вашего персонажа 
          <br />введите код из письма
        </p>
      </div>
